 ...
 * @typedef {object} Clingo.Config
 * @property {string} clingo - Clingo's path. Default: clingo
 * @property {number} maxModels - number of models Clingo will return. Default: 1
 * @property {Object} constants - key-value pairs
 * @property {array} inputFiles - array of string relative paths
 * @property {string|array|readable|object} input - input to be passed to child process's stdin
 * @property {array} args - array of string arguments
 * @property {boolean} returnStdin - returns stdin of the child process to client. Default: false
 * @property {boolean} returnStdout- returns stdout of the child process to client. Default: false
 */

 /**
  * Solution Object
  * @typedef {object} Clingo.Solution
  * @property {function} on - registers handlers for 'model' & 'end' events
  * @property {readable} stdout - child process's stdout
  * @property {writable} stdin - child process's stdin
  */


/**
 * @constructor Clingo
 * @param {Clingo.Config} config configurations
 */
...
/**
 * Replaces the current configurations
 * @param {Clingo.Config} newConfig new configurations
 */
...
/**
 * Updates the current configurations
 * @param {Clingo.Config} newConfig new Configurations
 * @returns {Clingo.Config} returns the current configurations if newConfig is null
 */
...
/**
 * Merges current configurations with new configurations
 * @private
 ...
 * @throws {Error} Config \'args\' property must be an Array
 */
...
/**
 * Spawns Clingo process and returns the answer models
 * @param {Clingo.Config} options configuration object
 * @returns {Clingo.Solution} you can register listeners and access stdin/stdout through the returned object
 */
